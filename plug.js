...
//		+ 	'<p id="plugbot-btn-userlist" style="color:#ED1C24">userlist</p>'
		...
		+ 	'<p id="plugbot-btn-youtube" style="color:#ED1C24"><a style="color: #F88017" href="http://www.youtube.com/watch?v=QNLyQZEW4Ok&feature=plcp" target="_blank">punks youtube</a></p>'
		+ 	'<h2 id="plugbot-btn-minecraft" style="color:#F88017"> <a style="color:#3FFF00"> Minecraft Server </a> </br> Server Status: <a style="color:#ED1C24"> Offline </a> </br> Server Ip: <a style="color:#3FFF00"> 108.246.72.228 </a> </br> Minecraft Download: <a style="color: #3FFF00" href="https://github.com/downloads/Punkred/DnBplug/Minecraft%20v1.3.1.zip" target="_blank">[X]</a></h2>'
);
} //3FFF00 ED1C24
