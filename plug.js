...
$('body').prepend('<style type="text/css" id="plugbot-css">' 
	...
	+ '#plugbot-ui p { background-color: #0b0b0b; height: 20px; padding-top: 8px; padding-left: 12px; cursor: pointer; font-variant: small-caps; width: 98px; font-size: 14px; margin: 0; }'
