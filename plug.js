...
function displayUI()
{
	...
	$('#plugbot-ui').append(
		...
		+ 	'<p id="plugbot-btn-minecraft" style="color:#ED1C24"><a style="color: #3FFF00" href="http://www.mediafire.com/?gcv0eu8u68wtetu" target="_blank">minecraft</a></p>'
...
$('body').prepend('<style type="text/css" id="plugbot-css">' 
	...
	+ '#plugbot-ui p { background-color: #0b0b0b; height: 30px; padding-top: 8px; padding-left: 12px; cursor: pointer; font-variant: small-caps; width: 98px; font-size: 14px; margin: 0; }'
