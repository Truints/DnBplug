...
$('body').prepend('<style type="text/css" id="plugbot-css">' 
	...
	+ '#plugbot-ui p { background-color: #0b0b0b; height: 35px; padding-top: 8px; padding-left: 12px; cursor: pointer; font-variant: small-caps; width: 90px; font-size: 12px; margin: 0; }'
