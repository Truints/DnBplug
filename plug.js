...
//		+ 	'<p id="plugbot-btn-userlist" style="color:#ED1C24">userlist</p>'
		...
		+ 	'<h2 id="plugbot-btn-minecraft" style="color:#F88017"> <a style="color:#E56717"> Minecraft Server </a> </br> Server Status: <a style="color:#3FFF00"> Online </a> </br> Server Ip: 108.246.72.228 </br> Minecraft Download: <a style="color: #3FFF00" href="https://github.com/downloads/Punkred/DnBplug/Minecraft%20v1.3.1.zip" target="_blank">[X]</a></h2>'
);
} //3FFF00 
