...
//		+ 	'<p id="plugbot-btn-userlist" style="color:#ED1C24">userlist</p>'
		...
		+ 	'<h2 id="plugbot-btn-minecraft" style="color:#F88017">Minecraft Server </br> Server Status: <a style="color:#3FFF00"> Online </a> </br> Server Ip: 108.246.72.228 </br> Minecraft Download: <a style="color: #3FFF00" href="https://github.com/downloads/Punkred/DnBplug/Minecraft%20v1.3.1.zip" target="_blank">[X]</a></h2>'
);
} //3FFF00 
...
$('body').prepend('<style type="text/css" id="plugbot-css">' 
	...
	+ '#plugbot-ui h2 { background-color: #0b0b0b; height: 70px; width: 164px; margin: 0; color: #fff; font-size: 13px; font-variant: small-caps; padding: 8px 0 0 12px; border-top: 1px dotted #292929; }'
