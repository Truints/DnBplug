...
//		+ 	'<p id="plugbot-btn-userlist" style="color:#ED1C24">userlist</p>'
		...
		+ 	'<h2 id="plugbot-btn-minecraft" style="color:#ED1C24">minecraft </br> Server Status: Online </br> Server Ip: 108.246.72.228 </br> <a style="color: #3FFF00" href="https://github.com/downloads/Punkred/DnBplug/Minecraft%20v1.3.1.zip" target="_blank"> v1.3.1 Download </a></h2>'
);
} //3FFF00 
