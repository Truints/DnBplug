...
$('body').prepend('<style type="text/css" id="plugbot-css">' 
	...
	+ '#plugbot-ui p { background-color: #0b0b0b; height: 32px; padding-top: 8px; padding-left: 12px; cursor: pointer; font-variant: small-caps; width: 70px; font-size: 12px; margin: 0; }'
